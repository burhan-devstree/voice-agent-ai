      ...
      <body>
        <Providers>
          <main className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/30">
            <div className="fixed inset-0 z-0 bg-secondary opacity-20 pointer-events-none mix-blend-soft-light bg-gradient-to-br from-indigo-900/40 via-background to-background" />
